...
- [1.3版本](https://github.com/314baidashi/SRT-translation)：适合所有用户，无需安装额外软件，开箱即用（157MB）[点击此处下载最新版exe安装包](https://pan.baidu.com/s/1quidFK9-UULF-7TIG3Rawg?pwd=vkji)
- 2.2版本：需要安装Ollama，适合有经验的用户，支持更多语言和更好的翻译效果（17MB）[请点击右侧Release下载最新版本]
...
- 如果浏览器提示木马风险，请不要担心，这是因为本软件为小范围自用，仅经过简单打包
- 确保Ollama服务正常运行
- 建议使用较大的模型以获得更好的翻译效果
- 翻译大文件时可能需要较长时间
- 可以随时中止翻译过程
